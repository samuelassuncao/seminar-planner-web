...
function App() {
  ...
  const [result, setResult] = useState<SeminarPlan | null>(null);
  ...
  async function handleSubmit(event: React.SubmitEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const seminarPlan: SeminarPlan = await response.json();
          ...
          <form className="form" onSubmit={handleSubmit}>
            ...
            {isLoading && (
              <p className="loading-message">
                A IA está organizando os tópicos, participantes e slides.
