...
function App() {
  ...
  async function handleSubmit(event: React.SubmitEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const seminarPlan: FinalSeminarPlan = await response.json();
    ...
    <main className="page">
      <section className="container">
        <header className="header">
          ...
          <p>
            Planeje seu seminário de forma rápida e organizada com auxílio de
        ...
        {result ? (
          ...
          <form className="form" onSubmit={handleSubmit}>
            <div className="field">
              <label htmlFor="title">Tema do seminário</label>
            ...
            <div className="field">
              <label htmlFor="mandatoryTopics">
                Tópicos obrigatórios <span>opcional</span>
              </label>

              <textarea
                id="mandatoryTopics"
                value={mandatoryTopics}
                onChange={(event) => setMandatoryTopics(event.target.value)}
                placeholder={
                  "Um tópico por linha\nEx.: Conceito\nBenefícios\nRiscos"
                }
                disabled={isLoading}
              ...
              <small>Informe um tópico por linha.</small>
            </div>
            ...
            <div className="field">
              ...
              <small>Informe uma referência por linha.</small>
            </div>

            {error && (
              <div className="error-message" role="alert">
                <strong>Não foi possível criar o planejamento</strong>
            ...
            {isLoading && (
              <p className="loading-message">
                A IA está organizando os tópicos, participantes e slides. Isso
