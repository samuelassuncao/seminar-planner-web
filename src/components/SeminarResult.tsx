...
return ( <section className="result"> <header className="result-header"> <div> <span className="result-label">Planejamento criado</span> <h2>{plan.title}</h2> <p>
{plan.total_duration_minutes} minutos ·{" "}
{plan.participants.length} participantes </p> </div> </header>
